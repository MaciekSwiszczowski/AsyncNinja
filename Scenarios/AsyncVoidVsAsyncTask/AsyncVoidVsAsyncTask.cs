...
namespace Scenarios.AsyncVoidVsAsyncTask
{
    public class AsyncVoidVsAsyncTask : IRunnable
    {
        ...
        public string Comment { get; } = "async void methods are pure evil!" + Environment.NewLine + Environment.NewLine + 
                                         "The first exception is caught, even though it was fired from a different thread." + Environment.NewLine + 
